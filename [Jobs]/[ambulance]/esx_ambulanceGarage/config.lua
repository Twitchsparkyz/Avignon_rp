...
Config.CarZones = {
	ambulanceCarGarage = {
		Pos = {
			{x = 295.65,  y = -578.69, z = 43.17},
			{x = -1652.69,  y = 64.59, z = 63.33},
		}
	}
}
...
Config.ambulanceVehicles = {
	 	{ model = '', label = '___ VL ___'},
	 	{ model = 'vlchef', label = 'vl du chef SP'},
	 	{ model = 'peug3008', label = 'vl du chef de centre'},
		{ model = 'vlcg', label = 'vl1'},
		{ model = 'VLCGKANGOO', label = 'vlcc'},
	--	{ model = 'bana5', label = 'vl du chef SAMU'},
        { model = '', label = '___ VSAV ___'},	
		{ model = 'vsavcube', label = 'VSAV1'},
		{ model = 'vsav', label = 'VSAV2'},
	--	{ model = 'vsavsp1', label = 'VSAV3'},
		{ model = 'vsav752', label = 'VsavCube SAMU'},
		{ model = 'T6SAMU', label = 'VW SAMU'},
		{ model = 'rsb_mbsprinter', label = 'AR SAMU'},
		{ model = '', label = '___ ACCIDENT ___'},
		{ model = 'fsr', label = 'FSR'},
		{ model = '', label = '___ INCENDIE ___'},
	--	{ model = 'fptld12', label = 'FPT'},
		{ model = 'epa', label = 'ECHELLE'},
		{ model = 'ccgc', label = 'CCGC'},
		{ model = 'ccf74', label = 'CCF'},
		{ model = 'firetruk', label = 'FMOGP'},
		{ model = '', label = '___ GRIMP ___'},
	--	{ model = 'vlhr', label = 'VLHR'},
		{ model = '', label = '___ DIVERS___'},
	--	{ model = 'gnr_thilux', label = 'Samu_Toyota_Hilux'},
		{ model = 'helismur', label = 'helismur'},
		{ model = 'ec145', label = 'Dragon'},
	--	{ model = 'anpc_npathfinder', label = 'Samu_Nissan_Pathfinder'},
}

-- ambulance Helicopters:
Config.ambulanceHelicopters = {
	{ model = 'supervolito', label = 'ambulance Maverick', livery = 0, price = 0 }
}
...
Config.TitleambulanceGarage = "Garage Samu / Pompier"
...
Config.CarOutFromPolGar = "Vous avez sortit un ~b~Véhicule~s~ du ~y~Garage~s~!"
Config.HeliOutFromPolGar = "Vous avez sortit un ~b~Hélicoptère du~s~ from ~y~Garage~s~!"
Config.BoatOutFromPolGar = "Vous avez sortit un ~b~Bateau~s~ du ~y~Garage~s~!"
Config.VehRepNotify = "Votre ~b~Véhicule~s~ est entrain d'être ~y~réparé~s~. Attendez !"
Config.VehRepDoneNotify = "Votre ~b~Véhicule~s~ a été ~y~réparé~s~!"
Config.VehCleanNotify = "Votre ~b~Véhicule~s~ est entrain d'être ~y~nettoyé~s~. Attendez !"
...
Config.VehicleLoadText = "Attendez que votre véhicule soit livré"			-- text on screen when vehicle model is being loaded
