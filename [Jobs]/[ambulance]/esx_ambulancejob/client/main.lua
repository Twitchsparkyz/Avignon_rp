...
RMenu.Add('signalenvoyer', 'maines', RageUI.CreateMenu("Signal", "~b~Envoyer au Médecin"))
	...
	Citizen.CreateThread(function()
		while menuambulancejoblol do
				...
				RageUI.IsVisible(RMenu:Get('mortmenuambu', 'maines'), true, true, true, function()
                    ...
                    RageUI.ButtonWithStyle("Appuyez sur ~g~ENTRER~s~ pour envoyer le signal", nil, {}, true, function(h, a, s)
						if s then
							...
							ESX.ShowAdvancedNotification("Détresse", "~g~Samu / Pompier", "Ta position a était envoyer au Médecin en Service", "CHAR_CALL911", 7)
						end
				...
				RageUI.IsVisible(RMenu:Get('signalenvoyer', 'maines'), true, true, true, function()
					...
					RageUI.Separator("")
                    RageUI.ButtonWithStyle("Position envoyer..", "~o~Tu dois attendre qu'un ~g~Médecin~o~ vienne a ton secours", {}, true, function(h, a, s)
						if s then
                        end
					end)
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		ESX.TriggerServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function()
			ESX.SetPlayerData('lastPosition', Config.RespawnPoint.Pos)
			ESX.SetPlayerData('loadout', {})
			
			TriggerServerEvent('esx:updateLastPosition', Config.RespawnPoint.Pos)
			
			RespawnPed(PlayerPedId(), Config.RespawnPoint)
			DoScreenFadeIn(800)
			RageUI.CloseAll()
