...
Config.ambulanceDatabaseName = 'police'	-- set the exact name from your jobs database for ambulance

--ambulance Car Garage:
Config.CarZones = {
	ambulanceCarGarage = {
		Pos = {
			{x = 457.45,  y = -982.75, z = 25.7},
			{x = 477.31,  y = -1021.93, z = 28.03},  
		}
	}
}
...
Config.ambulanceVehicles = {
        { model = '', label = '_____ PAM _____'},	
		{ model = '5008gn', label = 'Peugeot 5008'},
		{ model = 'police2', label = 'Mercedes'},
        { model = 'traficgn', label = 'traficgn'},

		{ model = '', label = '_____ PMO _____'},
		{ model = 'police', label = 'VW Arteon'},
		{ model = 'policeb', label = 'Yamaha FJR 1300'},
		{ model = 'polmun2', label = 'Clio'},
		{ model = 'meganers', label = 'meganers'},


		{ model = '', label = '_____ PSIG _____'},
	--	{ model = 'fbi', label = 'touranpsig'},
		{ model = 'vsharanpsig', label = 'sharanpsig'},
        
      
		

		{ model = '', label = '___ UTILITAIRES ___'},
	    { model = 'mastergm', label = 'master tp'},
	    { model = 'transitgn', label = 'Ford transit'},
	    { model = 'bdf', label = 'ne pas toucher ici bdf'},
	    { model = 'riot2', label = 'anti emeute'},
	    { model = 'drap', label = 'anti emeute'},
	    

	    { model = '', label = '___ banaliser ___'},
	    { model = 'dgrsp_vwtouran', label = 'touran'},
}

-- ambulance Helicopters:
Config.ambulanceHelicopters = {
	{ model = 'supervolito', label = 'Hélicoptère Gendarmerie', livery = 0, price = 0 }
}
...
Config.TitleambulanceGarage = "Garage Gendarmerie"
