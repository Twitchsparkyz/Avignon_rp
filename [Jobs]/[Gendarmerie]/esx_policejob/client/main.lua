...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = '_____ Tenues _____', value = '' },
		{ label = 'Tenue Manche Court', value = 'tenu_ma' },
		...
		{ label = 'Tenue FAGN', value = 'tenu_pilote' },
		{ label = '_____ GPB _____', value = '' },
		{ label = 'GPB 1', value = 'bullet_wear' },
		{ label = 'GPB 2', value = 'bullet2_wear' },
		{ label = 'GPB 3', value = 'bullet2_wear' },
        { label = 'Chapeau 1', value = 'helmet1_wear' },
