...
Config.Zones = {
	...
	Garages = {
		...
		--{ -- paco cayo
		   -- GaragePos  = vector3(4889.51, -5165.80, 2.45),
		    --SpawnPoint = vector4(4900.48, -5145.98, -0.48, 181.0),
		    --StorePos   = vector3(4897.91, -5152.79, -0.48),
		    --StoreTP    = vector4(4897.40, -5170.38, 2.5, 2.48)
	   -- },
