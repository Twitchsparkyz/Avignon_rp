	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reseller', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'set_vehicle_owner_sell_amount', {
				...
				if amount == nil then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        exports.JD_logs:discord("Facture de $:  "..data2.value, GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), '#FFFFFF','concess_billing')
					end
		...
		elseif action == 'set_vehicle_owner_sell' then
			...
			if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                exports.JD_logs:discord("Attribution vehicule:  "..model ..'  plaque  :'..newPlate, GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), '#7200FF', 'concess_sell')
