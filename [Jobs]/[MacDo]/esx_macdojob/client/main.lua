...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'macdo' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'macdo_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('macdo_outfit'),    value = 'macdo_outfit'},
  }
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'macdo_outfit' then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'macdo', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'macdo_actions',
    {
      title    = _U('macdo'),
      align    = 'top-left',
      elements = elements
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_macdo', _U('billing'), amount)
			exports.JD_logs:discord("Facture de $:  "..data2.value, GetPlayerServerId(PlayerId()), closestPlayer, '#FFFFFF', 'MacDo_billing')
        end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
			  ...
			  exports.JD_logs:discord("Prend dans le Stock MacDo:  "..count ..'x    '..itemName, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'MacDo_coffre')
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
			  ...
			  exports.JD_logs:discord("Depot Stock MacDo:  "..count ..'x    '..itemName, GetPlayerServerId(PlayerId()), 0, '#55FF00', 'MacDo_coffre')
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_burgerjob:putStockItems', itemName, count)
			  exports.JD_logs:discord("Depot Stock MacDo xx2xx:  "..count ..'x    '..itemName, GetPlayerServerId(PlayerId()), 0, '#55FF00', 'MacDo_coffre')
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
			  ...
			  exports.JD_logs:discord("Retrait MacDo frigo:  "..count ..'x    '..itemName, GetPlayerServerId(PlayerId()), 0, '#FF0000', 'MacDo_fridge')
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
			  ...
			  exports.JD_logs:discord("Depot MacDo frigo:  "..count ..'x    '..itemName, GetPlayerServerId(PlayerId()), 0, '#55FF00', 'MacDo_fridge')
            end
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'macdo_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
			...
			exports.JD_logs:discord("Achat Food MacDo:  "..data.current.value ..'x '..data.current.price ..'€  nom réel'..data.current.realLabel , GetPlayerServerId(PlayerId()), 0, '#FF0000', 'MacDo_buy')
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_burgerjob:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
  if (zone == 'KetchupFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'macdo' then
    TriggerServerEvent('esx_burgerjob:stopHarvest')
  end  
  if (zone == 'SachetKetchup') and PlayerData.job ~= nil and PlayerData.job.name == 'macdo' then
    TriggerServerEvent('esx_burgerjob:stopTransform')
  end
  if (zone == 'SellFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'macdo' then
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'macdo', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'macdo')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'macdo', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'macdo_actions') then
...
-- CREATE BLIPS
Citizen.CreateThread(function()
    local MacDo = AddBlipForCoord(Config.Blips.Blip.Pos.x, Config.Blips.Blip.Pos.y, Config.Blips.Blip.Pos.z)
    SetBlipSprite(MacDo, Config.Blips.Blip.Sprite)
    SetBlipColour(MacDo, Config.Blips.Blip.Colour)
    SetBlipScale(MacDo, Config.Blips.Blip.Scale)
	SetBlipDisplay(MacDo,Config.Blips.Blip.Display)
    SetBlipAsShortRange(MacDo, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("MacDo")
    EndTextCommandSetBlipName(MacDo)
end)
