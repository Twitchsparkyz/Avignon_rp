Locales['fr'] = {
    ...
    ['macdo_fridge_stock']     = 'Frigo du macdo',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du macdo',
