...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'macdo', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'macdo', _U('macdo_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'macdo', 'macdo', 'society_macdo', 'society_macdo', 'society_macdo', {type = 'private'})
      ...
      if xPlayer.getInventoryItem('sachetketchup').count <= 0 then
        ...
        if (ketchup <= 10) then
          SetTimeout(1100, function()
            ...
            local money = math.random(8,13)
            xPlayer.removeInventoryItem('sachetketchup', 10)
            xPlayer.addMoney(money)
              TriggerClientEvent('esx:showNotification', xPlayer.source, _U('comp_earned_private') .. money)
            local societyAccount = nil

            TriggerEvent('esx_addonaccount:getSharedAccount', 'society_macdo', function(account)
...
AddEventHandler('esx_burgerjob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_macdo', function(inventory)
...
AddEventHandler('esx_burgerjob:getFridgeStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_macdo_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_burgerjob:getVaultWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_macdo', function(store)
