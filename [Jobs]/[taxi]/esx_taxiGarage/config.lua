...
Config.ambulanceDatabaseName = 'taxi'	-- set the exact name from your jobs database for ambulance

--Taxi Car Garage:
Config.CarZones = {
	taxiCarGarage = {
		Pos = {
			{x = 896.81, y = -152.85, z = 76.56}, 
		}
	}
}
...
-- taxi Boat Garage Blip Settings:
...
-- taxi Car Garage Marker Settings:
...
-- taxi Heli Garage Marker Settings:
...
-- taxi Boat Garage Marker Settings:
...
-- taxi Extra Garage Marker Settings:
...
Config.ambulanceVehicles = {	
	--	{ model = 'taxi2', label = 'Taxi Mercedes'},
		{ model = 'trans_teslams', label = 'Taxi Tesla'},	
		{ model = 'trans_mbv250', label = 'Van Mercedes'},
}
...
Config.TitleambulanceGarage = "Taxi Garage"
...
Config.CarOutFromPolGar = "Vous avez sortit un ~b~Véhicule~s~ du ~y~garage Taxi ~s~!"
Config.HeliOutFromPolGar = "You took out a ~b~Helicopter~s~ from ~y~taxi Heli Garage~s~!"
Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~taxi Boat Garage~s~!"
Config.VehRepNotify = "Ton ~b~vehicule~s~ est entrain d'être ~y~réparé~s~, attendez!"
Config.VehRepDoneNotify = "Ton ~b~véhicule~s~ a été ~y~réparé~s~!"
Config.VehCleanNotify = "Ton ~b~véhicule~s~ est entrain d'être ~y~nettoyé~s~, attendez!"
Config.VehCleanDoneNotify = "Ton ~b~véhicule~s~ a été ~y~nettoyé ~s~!"
...
Config.VehicleLoadText = "Attend que ton véhicule soit livré"			-- text on screen when vehicle model is being loaded
