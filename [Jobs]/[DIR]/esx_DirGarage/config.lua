...
Config.PoliceDatabaseName = 'mechanic'	-- set the exact name from your jobs database for police
...
Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~DIR Extra Menu~s~"		-- set your desired text here
...
Config.PoliceVehicles = {
		...
		{ model = '', label = '_____ PLATEAU _____'},

		{ model = 'flatbed3', label = 'DIR_Mercedes_Actros_Plateau'},
		
	--	{ model = 'towtruck', label = 'DIR_depanneuse à crochetu'},

		{ model = '17silv', label = 'DIR_CHRYSLER '},
		
		{ model = '', label = '_____ VOITURE _____'},
		
		{ model = 'serv_bmws1', label = 'DIR_BMW_S1'},

        { model = '', label = '_____ UTILITAIRES _____'},

		{ model = 'STUARTE1528', label = 'DIR_Mercedes_Traffic'},

        { model = 'Master3', label = 'DIR_Renault_Master_3_Balisage'},

        { model = '', label = '_____ ENGINS _____'},

     --   { model = 'cat259', label = 'caterpillar'},
...
Config.TitlePoliceGarage = "DIR Garage"
...
Config.CarOutFromPolGar = "You took out a ~b~Vehicle~s~ from ~y~DIR Garage~s~!"

Config.HeliOutFromPolGar = "You took out a ~b~Helicopter~s~ from ~y~DIR Heli Garage~s~!"

Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~DIR Boat Garage~s~!"
...
Config.VehicleLoadText = "Attendez que votre véhicule apparaisse."			-- text on screen when vehicle model is being loaded
