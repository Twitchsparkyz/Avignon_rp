    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           exports.JD_logs:discord("Annonce Tabac:  "..result, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'annonce_tabac')
        end
    end
  end)
                  ...
                  function(data2, menu2)
                    ...
                    local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                      if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        exports.JD_logs:discord("Facture de $:  "..amount, GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), '#FFFFFF', 'Tabac_factures')
                      end
                    end
                  end,
                function(data2, menu2)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              exports.JD_logs:discord("Retrait item coffre:  "..count ..'  item:  '..itemName, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'Tabac_Coffre')
            end
