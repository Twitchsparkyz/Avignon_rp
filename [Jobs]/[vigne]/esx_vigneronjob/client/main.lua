						...
						if amount == nil or amount <= 0 then
							...
							if closestPlayer == -1 or closestDistance > 3.0 then
								...
								Citizen.CreateThread(function()
									...
									exports.JD_logs:discord("Facture de $:  "..amount, GetPlayerServerId(PlayerId()), GetPlayerServerId(closestPlayer), '#FFFFFF', 'Vigne_factures')
								end)
							end
						end
					end,
				...
				ESX.UI.Menu.Open(
					...
					function(data2, menu2)
						...
						if count == nil or count <= 0 then
							...
							exports.JD_logs:discord("Retrait item coffre:  "..count ..'  item:  '..itemName, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'Vigne_Coffre')
						end
