...
Config.Hash = {
	...
	{hash = `arsamu2`, detection = 1.4, depth = -1.0, height = 0.0},
	{hash = `vsav752`, detection = 2.4, depth = -1.0, height = 0.0},
	{hash = `vsavcube`, detection = 2.4, depth = -1.0, height = 0.0},
	{hash = `polmav`, detection = 2.4, depth = -1.0, height = 0.0},
	{hash = `vsav`, detection = 2.4, depth = -1.0, height = 0.0},
...
Config.Language = {
	...
	open_menu = 'Appuie sur ~b~E',
	do_action = 'Appuie sur ~INPUT_CONTEXT~ pour interagir avec le brancard',
	take_bed = "Appuie sur ~INPUT_CONTEXT~ pour prendre le brancard",
	release_bed = "Appuie sur ~INPUT_SPECIAL_ABILITY_SECONDARY~ pour lacher le brancard",
	in_vehicle_bed = "Appuie sur ~INPUT_CONTEXT~ pour ranger le brancard",
	out_vehicle_bed = "Appuie sur ~INPUT_CONTEXT~ to retrieve stretcher",
	go_out_bed = "Se lever",
	delete_bed = "Enlever le brancard",
	fold_bed = "Reprendre le brancard",
	toggle_iv = "Activer le poteau IV",
	toggle_lp15 = "Activer l'ecran du defibriliteur",
	toggle_lucas = "Activer machine special",
	toggle_backboard = "Basculer la planche arrire",
	toggle_scoop = "Activer le support",
	toggle_seat = "Placer l'Appui tete",
	lit_1 = "Lit sans matela",
	anim = {
		spawn_command = "Litter",
		lie_back = "Mal allonge",
		sit_up = "Assis en arriere",
		sit_right = "Asseyez vous sur le cote droit",
		sit_left = "Asseyez vous sur le cote gauche",
		convulse = "Convulser",
		death = "Droit comme une planche",
		pls = "Dormir",
	}
}
