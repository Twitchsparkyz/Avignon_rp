...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.goopics.net/2AvDr.png",
...
Config.Languages = {
  ...
  ['fr'] = {
        ['emotes'] = '~p~Emotes',
        ['danceemotes'] = "🕺 ~r~Les Danses",
        ['propemotes'] = "📦 ~b~Animations objets",
        ['favoriteemotes'] = "🌟 ^1Favori",
        ...
        ['shareemotes'] = "👫 ~y~Action partagées",
        ['shareemotesinfo'] = "Inviter une personne proche à emoter",
        ['sharedanceemotes'] = "🕺 ~r~Dances partagées",
