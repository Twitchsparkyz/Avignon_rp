...
function RenderText(Text, X, Y, Font, Scale, R, G, B, A, Alignment, DropShadow, Outline, WordWrap)
    ...
    ---@type table
    local Text, X, Y = tostring(Text), (tonumber(X) or 6) / 1920, (tonumber(Y) or 6) / 1080

    SetTextFont(Font or 0)
    --SetTextScale(1.0, Scale or 0.06)
    SetTextScale(0.35,Scale or 0.35)
