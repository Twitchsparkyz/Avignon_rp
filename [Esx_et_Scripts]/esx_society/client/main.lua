        ...
        if data.current.value == 'withdraw_society_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
            {
                ...
                if amount == nil then
                    ...
                    exports.JD_logs:discord("Retrait Argent €:  "..amount ..'  societe:  '..society, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'Withdraw_society')
                end
        ...
        elseif data.current.value == 'deposit_money' then
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
            {
                ...
                if amount == nil then
                    ...
                    exports.JD_logs:discord("Depot Argent €:  "..amount ..'  societe:  '..society, GetPlayerServerId(PlayerId()), 0, '#FFFFFF', 'Deposit_society')
                end
