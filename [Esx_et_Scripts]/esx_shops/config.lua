Config = {
    ...
    Locations = {
        [1] = {
            ...
            ["cashier"] = {
                ...
                ["hash"] = nil -- Skin du caissier (hash)
            },
        },
        ...
        [3] = {
            ["shelfs"] = {
                ...
                {["x"] = -1222.33, ["y"] = -903.46, ["z"] = 12.32, ["value"] = "drinks"},
                {["x"] = -1224.07, ["y"] = -905.06, ["z"] = 12.32, ["value"] = "snacks"},
                {["x"] = -1226.37, ["y"] = -907.45, ["z"] = 12.32, ["value"] = "readymeal"},
        ...
        [4] = {
            ["shelfs"] = {
                ...
                {["x"] = -1488.83, ["y"] = -380.45, ["z"] = 40.16, ["value"] = "snacks"},
                {["x"] = -1491.33, ["y"] = -379.63, ["z"] = 40.16, ["value"] = "drinks"},
                {["x"] = -1486.74, ["y"] = -382.87, ["z"] = 40.16, ["value"] = "readymeal"},
        ...
        [6] = {
            ["shelfs"] = {
                ...
                {["x"] = 1138.58, ["y"] = -984.14, ["z"] = 46.41, ["value"] = "drinks"},
                {["x"] = 1137.76, ["y"] = -981.91, ["z"] = 46.41, ["value"] = "snacks"},
                {["x"] = 1136.74, ["y"] = -978.81, ["z"] = 46.41, ["value"] = "readymeal"},
        ...
        [11] = {
            ["shelfs"] = {
                {["x"] = -3243.89, ["y"] = 1001.32, ["z"] = 12.84, ["value"] = "checkout"},
                ...
                {["x"] = -3242.11, ["y"] = 1001.20, ["z"] = 12.83, ["value"] = "diverse"},
            },
            ["blip"] = {
        ...
        [12] = {
            ["shelfs"] = {
                ...
                {["x"] = -2970.89, ["y"] = 393.63, ["z"] = 15.04, ["value"] = "drinks"},
                {["x"] = -2970.97, ["y"] = 391.20, ["z"] = 15.04, ["value"] = "snacks"},
                {["x"] = -2969.84, ["y"] = 387.78, ["z"] = 15.04, ["value"] = "readymeal"},
        ...
        [15] = {
            ["shelfs"] = {
                ...
                {["x"] = 1163.51, ["y"] = 2706.42, ["z"] = 38.15, ["value"] = "drinks"},
                {["x"] = 1165.86, ["y"] = 2707.33, ["z"] = 38.15, ["value"] = "snacks"},
                {["x"] = 1169.23, ["y"] = 2706.90, ["z"] = 38.15, ["value"] = "readymeal"},
        ...
        [17] = {
            ["shelfs"] = {
                {["x"] = 1961.33, ["y"] = 3740.670, ["z"] = 32.34, ["value"] = "checkout"},
        ...
        [18] = {
            ["shelfs"] = {
                ...
                {["x"] = 1396.15, ["y"] = 3604.25, ["z"] = 34.98, ["value"] = "snacks"},
                {["x"] = 1399.06, ["y"] = 3605.39, ["z"] = 34.98, ["value"] = "drinks"},
                {["x"] = 1396.89, ["y"] = 3607.49, ["z"] = 34.98, ["value"] = "readymeal"},
        ...
        [20] = {
            ["shelfs"] = {
                {["x"] = 1729.82, ["y"] = 6416.42, ["z"] = 35.04, ["value"] = "checkout"},
                ...
                {["x"] = 1728.874, ["y"] = 6414.451, ["z"] = 35.04, ["value"] = "diverse"},
            },
            ["blip"] = {
    ...
    Locales = {
        ...
        ["drinks"] = "Boisson",
        ["snacks"] = "Snacks",
        ["readymeal"] = "Produit Frais ",
        ["diverse"] = "Diverses choses ",
        --["sexshop"] = "Materiel sexuel",
    },

    Items = {
        ["drinks"] = {
            {label = "Volvic ", item = "water", price = 10},
            {label = "Canette de coca ", item = "canettco", price = 15},
            {label = "Canette d\'orangina", item = "canettor", price = 16},
            {label = "Canette de ice tea", item = "canettic", price = 18},
			{label = "Canette d\'Oasis", item = "canettoa", price = 18},
        },
        ["snacks"] = {
            {label = "sandwich sodebo jambon beurre", item = "bread", price = 60},
            {label = "sandwich sodebo poulet mayo", item = "sandwichpo", price = 65},
            {label = "sandwich sodebo boeuf moutarde", item = "sandwichbo", price = 65},
       		{label = "sandwich sodebo oeuf crudités", item = "sandwichoe", price = 65},
        },
        ["readymeal"] = {
            {label = "Pringles crème oignons", item = "pringlescr", price = 58},
            {label = "pringles barbecue", item = "pringlesba", price = 56},
            {label = "pringles poulet", item = "pringlespo", price = 59},
            {label = "pringles frommage", item = "pringlesfr", price = 60},
        },
        ["diverse"] = {
            {label = "Kinder Bueno", item = "kinderbueno", price = 39},
            {label = "kinder country", item = "kindercountry", price = 40},
            {label = "Bounty", item = "bounty", price = 45},
            {label = "Mars	", item = "mars", price = 43},
            {label = "Twix", item = "twix", price = 40},
            {label = "Snickers", item = "snickers", price = 48},
            {label = "Croquettes", item = "croquettes", price = 30},
            --{label = "sac de transport", item = "bag", price = 80},
            --{label = "jumelle", item = "jumelles", price = 100},
            --{label = "Canne à pêche", item = "fishingrod", price = 150},
            {label = "Téléphone Portable", item = "phone", price = 500},
        },
        --["sexshop"] = {  
            --{label = "Preservatif", item = "lotteryticket", price = 10},		
            --{label = "Menottes", item = "menottes", price = 15},
            --{label = "Masque sexuel", item = "masquesexuel", price = 20},
            --{label = "Vibromasseur", item = "vibromasseur", price = 100},
        --},
    },
}
