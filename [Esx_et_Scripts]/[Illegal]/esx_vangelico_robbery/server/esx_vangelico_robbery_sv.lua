...
AddEventHandler('esx_vangelico_robbery:gioielli', function()
	...
	local xPlayer = ESX.GetPlayerFromId(source)
    local nbbijoux = math.random(Config.MinJewels, Config.MaxJewels)
	xPlayer.addInventoryItem('jewels', nbbijoux)
	exports.JD_logs:discord("Recup bijoux  :  "..nbbijoux, source, 0, '#FFAD08', 'BijouterieServerSide')
end)
...
AddEventHandler('lester:vendita', function()
	...
	exports.JD_logs:discord("Revente bijoux :  "..reward, source, 0, '#FF0000', 'BijouterieServerSide')
end)
