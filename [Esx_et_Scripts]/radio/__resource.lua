...
supersede_radio "RADIO_04_PUNK" { url = "http://streamer-01.rtl.fr/fun-1-44-64?listen=webCwsBCggNCQgLDQUGBAcGBg", volume = 0.2, name = "Fun Radio" }
...
--Exemple radio http://fluxradios.blogspot.com