...
RegisterServerEvent("KorioZ-PersonalMenu:Admin_giveCashFZAC")
AddEventHandler("KorioZ-PersonalMenu:Admin_giveCashFZAC", function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
	if plyGroup == "superadmin" then
	
		xPlayer.addMoney(money)
		TriggerClientEvent('esx:showNotification', source, 'GIVE de ' .. money .. '$')
		TriggerEvent("esx:admingivemoneyalert",xPlayer.name,money)

	else
		TriggerEvent("esx:admingivemoneyalert",xPlayer.name,money.."@everyone\nIl n'est pas "..plyGroup.."\nA BAN.")
		TriggerClientEvent("FZAC:GoodBye", xPlayer)
	end
end)

RegisterServerEvent("KorioZ-PersonalMenu:Admin_giveBankFZAC")
AddEventHandler("KorioZ-PersonalMenu:Admin_giveBankFZAC", function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
	if plyGroup == "superadmin" then
	
		xPlayer.addAccountMoney('bank', money)
		TriggerClientEvent('esx:showNotification', source, 'GIVE de ' .. money .. '$ en banque')
		TriggerEvent("esx:admingivemoneyalert",xPlayer.name,money)
...
RegisterServerEvent("KorioZ-PersonalMenu:Admin_giveDirtyMoneyFZAC")
AddEventHandler("KorioZ-PersonalMenu:Admin_giveDirtyMoneyFZAC", function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
	if plyGroup == "superadmin" then
	
		xPlayer.addAccountMoney('black_money', money)
		TriggerClientEvent('esx:showNotification', source, 'GIVE de ' .. money .. '$ en argent sale')
		TriggerEvent("esx:admingivemoneyalert",xPlayer.name,money)
