...
AddEventHandler('esx_outlawalert:carJackInProgress', function(targetCoords, streetName, vehicleLabel, playerGender)
    mytype = 'police'
    data = {["code"] = '10-16', ["name"] = 'Vol de voiture  '   ..vehicleLabel..  '.', ["loc"] = streetName}
    length = 5500
...
AddEventHandler('esx_outlawalert:gunshotInProgress', function(targetCoords, streetName, playerGender)
	mytype = 'police'
    data = {["code"] = '10-11', ["name"] = 'Coup de feux en cours', ["loc"] = streetName}
    length = 5500
    TriggerClientEvent('esx_outlawalert:outlawNotify', -1, mytype, data, length)
...
RegisterServerEvent('esx_outlawalert:crochetage')
AddEventHandler('esx_outlawalert:crochetage', function(targetCoords, streetName, playerGender)
	mytype = 'police'
    data = {["code"] = '10-12', ["name"] = 'crochetage', ["loc"] = streetName}
    length = 5500
    TriggerClientEvent('esx_outlawalert:outlawNotify', -1, mytype, data, length)
    TriggerClientEvent('esx_outlawalert:carJackInProgress', -1, targetCoords)
end, false)
