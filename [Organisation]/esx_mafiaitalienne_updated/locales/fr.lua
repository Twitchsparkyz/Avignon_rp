Locales['fr'] = {
    ...
    ['mafiaitalienne_wear'] = 'tenue Policier',
    ...
    ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~mafiaitalienne~s~',
    -- Vehicle interaction
  ...
  ['confiscate_inv'] = 'confisquer x',
    ...
    ['mafiaitalienne_stock'] = 'coffre de la mafiaitalienne',
    -- Misc
    ...
    -- Notifications
    ['alert_mafiaitalienne'] = 'alerte mafiaitalienne',
    ['phone_mafiaitalienne'] = 'mafiaitalienne',
	['license_take'] = 'Licence confisqué',
	['from'] = '~s~ à ~b~',
