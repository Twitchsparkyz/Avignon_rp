...
RMenu.Add('LaVague', 'coffre', RageUI.CreateMenu("LaVague", "Coffre"))
RMenu.Add('LaVague', 'Retrait argent Sale', RageUI.CreateSubMenu(RMenu:Get('LaVague', 'coffre'), "LaVague", "coffre"))
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('LaVague', 'coffre'), true, true, true, function()
...
---=====================================	RETRAIT ARGENT SALE ======================		
			...
			if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'LaVague' and ESX.PlayerData.job2.grade_name == 'boss'  then
			RageUI.ButtonWithStyle("Retrait argent Sale", nil, {RightLabel = "→"},true, function()
				end, RMenu:Get('LaVague', 'Retrait argent Sale'))
				else
...
---===================================== MENU RETRAIT ARGENT SALE BOSS ======================	
			...
			RageUI.IsVisible(RMenu:Get('LaVague', 'Retrait argent Sale'), true, true, true, function()
...
function OpenGetStocksLaVagueMenu()
	ESX.TriggerServerCallback('esx_LaVaguejob:prendreitem', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_LaVaguejob:prendreitems', itemName, count)
...
function OpenPutStocksLaVagueMenu()
ESX.TriggerServerCallback('esx_LaVaguejob:inventairejoueur', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_LaVaguejob:stockitem', itemName, count)
...
function OpenGetBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_LaVaguejob:getBlackMoneySociety', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.type == 'item_weapon' then
          menu.close()
          TriggerServerEvent('esx_LaVaguejob:getItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                menu.close()
                TriggerServerEvent('esx_LaVaguejob:getItem', data.current.type, data.current.value, quantity)
                ESX.SetTimeout(300, function()
                  OpenGetBlackMoney()
                end)
              end
...
function OpenPutBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_LaVaguejob:getPlayerInventory2', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_LaVaguejob:putItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_LaVaguejob:putItem', data.current.type, data.current.value, tonumber(data2.value))
