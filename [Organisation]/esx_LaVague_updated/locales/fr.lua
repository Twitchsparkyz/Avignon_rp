Locales['fr'] = {
    ...
    ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~LaVague~s~',
    -- Vehicle interaction
  ...
  ['confiscate_inv'] = 'confisquer x',
    ...
    ['LaVague_stock'] = 'coffre de la LaVague',
    -- Misc
    ...
    -- Notifications
    ['alert_LaVague'] = 'alerte LaVague',
    ['phone_LaVague'] = 'LaVague',
