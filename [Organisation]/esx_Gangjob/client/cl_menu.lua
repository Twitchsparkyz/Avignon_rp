...
RMenu.Add('Gang', 'main', RageUI.CreateMenu("Gang", "Intéraction"))
RMenu.Add('Gang', 'inter', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'info', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'doc', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'renfort', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'voiture', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'chien', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'cam', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'megaphone', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))
RMenu.Add('Gang', 'PPA', RageUI.CreateSubMenu(RMenu:Get('Gang', 'main'), "Gang", "Intéraction"))  --add submenu ppa



Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('Gang', 'main'), true, true, true, function()
		...
		RageUI.IsVisible(RMenu:Get('Gang', 'inter'), true, true, true, function()
...
local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
	...
	RageUI.IsVisible(RMenu:Get('Gang', 'voiture'), true, true, true, function()
...
AddEventHandler('openf7', function()
	RageUI.Visible(RMenu:Get('Gang', 'main'), not RageUI.Visible(RMenu:Get('Gang', 'main')))
end)
...
Citizen.CreateThread(function()
    local Gangmap = AddBlipForCoord(439.14, -982.3, 30.69)
    SetBlipSprite(Gangmap, 60)
    SetBlipColour(Gangmap, 38)
    SetBlipScale(Gangmap, 0.99)
    SetBlipAsShortRange(Gangmap, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("[ETAT] Los Sntos Gang Departement")
    EndTextCommandSetBlipName(Gangmap)
end)
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'Gang') or (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'Gang') then 
	--    RegisterNetEvent('esx_Gangjob:onDuty')
