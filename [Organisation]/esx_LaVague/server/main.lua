...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'LaVague', Config.MaxInService)
end

-- TriggerEvent('esx_phone:registerNumber', 'LaVague', _U('alert_LaVague'), true, true)
TriggerEvent('esx_society:registerSociety', 'LaVague', 'LaVague', 'society_LaVague', 'society_LaVague', 'society_LaVague', {type = 'public'})

RegisterServerEvent('esx_LaVaguejob:giveWeapon')
AddEventHandler('esx_LaVaguejob:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_LaVaguejob:confiscatePlayerItem')
...
RegisterServerEvent('esx_LaVaguejob:getStockItem')
AddEventHandler('esx_LaVaguejob:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_LaVaguejob:putStockItems')
AddEventHandler('esx_LaVaguejob:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_LaVaguejob:getFineList', function(source, cb, category)

  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_LaVague WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_LaVaguejob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_LaVaguejob:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_LaVaguejob:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_LaVaguejob:getPlayerInventory', function(source, cb)
