...
local blips = {
  ...
  {title="~p~Quartier mafiaitalienne", colour=83, id=84, x = 104.67, y = -1938.46, z = 20.8}
  }
  Citizen.CreateThread(function()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'item' then
        TriggerServerEvent('esx_mafiaitalienne:buyItem')
      end

      if data.current.value == 'item1' then
        TriggerServerEvent('esx_mafiaitalienne:buyItem1')
      end

      if data.current.value == 'item2' then
        TriggerServerEvent('esx_mafiaitalienne:buyItem2')
      end
...
function OpenGetStocksBanditsMenu()
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getStockItemsBandits', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafiaitalienne:getStockItemsBandits', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_mafiaitalienne:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafiaitalienne:putStockItemsBandits', itemName, count)
            end
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mafiaitalienne:giveWeaponBandits', weapon,  1000)
      end,
      function(data, menu)
...
function OpenGetWeaponBanditsMenu(station)
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafiaitalienne:removeArmoryWeaponBandits', function()
...
function OpenPutWeaponBanditsMenu(station)
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mafiaitalienne:addArmoryWeaponBandits', function()
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafiaitalienne:buyBandits', function(hasEnoughMoney)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'formol' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startHarvestBandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'puce' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startHarvest2Bandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'spark' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startHarvest3Bandits')
        end

        if data.current.value == 'tesla' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startHarvest4Bandits')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'sedatif' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startCraftBandits')
        end

        if data.current.value == 'cryptedphone' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startCraft2Bandits')
        end

        if data.current.value == 'lightbreak' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:startCraft3Bandits')
        end
...
AddEventHandler('esx_mafiaitalienne:hasEnteredMarkerBandits', function(zone, station, part, partNum)
...
AddEventHandler('esx_mafiaitalienne:hasExitedMarkerBandits', function(zone, station, part, partNum)

  if zone == 'HarvestBandits' then
    TriggerServerEvent('esx_mafiaitalienne:stopHarvestBandits')
  end

  if zone == 'HarvestBandits2' then
    TriggerServerEvent('esx_mafiaitalienne:stopHarvest2Bandits')
  end  

  if zone == 'HarvestBandits3' then
    TriggerServerEvent('esx_mafiaitalienne:stopHarvest3Bandits')
    TriggerServerEvent('esx_mafiaitalienne:stopHarvest4Bandits')
  end
  
  if zone == 'CraftBandits' then
    TriggerServerEvent('esx_mafiaitalienne:stopCraftBandits')
    TriggerServerEvent('esx_mafiaitalienne:stopCraft2Bandits')
    TriggerServerEvent('esx_mafiaitalienne:stopCraft3Bandits')
  end
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafiaitalienne' then
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafiaitalienne' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_mafiaitalienne:hasExitedMarkerBandits', LastZone, LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_mafiaitalienne:hasEnteredMarkerBandits', currentZone, currentStation, currentPart, currentPartNum)
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafiaitalienne' and (GetGameTimer() - GUI.Time) > 300 then
...
AddEventHandler('esx_mafiaitalienne:teleportMarkers', function(position)
  ...
  -- while true do
    ...
    -- if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafiaitalienne' then
        ...
        -- if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          -- TriggerEvent('esx_mafiaitalienne:teleportMarkers', position)
        -- end
...
function OpenGetBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getBlackMoneySociety', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.type == 'item_weapon' then
          menu.close()
          TriggerServerEvent('esx_mafiaitalienne:getItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                menu.close()
                TriggerServerEvent('esx_mafiaitalienne:getItem', data.current.type, data.current.value, quantity)
                ESX.SetTimeout(300, function()
                  OpenGetBlackMoney()
                end)
              end
...
function OpenPutBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getPlayerInventory2', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_mafiaitalienne:putItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_mafiaitalienne:putItem', data.current.type, data.current.value, tonumber(data2.value))
