          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_mafiaitalienne:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_mafiaitalienne:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_mafiaitalienne:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_mafiaitalienne:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenBodySearchMenu(player)
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_mafiaitalienne:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_mafiaitalienne:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_mafiaitalienne:handcuff')
AddEventHandler('esx_mafiaitalienne:handcuff', function()
...
RegisterNetEvent('esx_mafiaitalienne:drag')
AddEventHandler('esx_mafiaitalienne:drag', function(cop)
...
RegisterNetEvent('esx_mafiaitalienne:putInVehicle')
AddEventHandler('esx_mafiaitalienne:putInVehicle', function()
...
RegisterNetEvent('esx_mafiaitalienne:OutVehicle')
AddEventHandler('esx_mafiaitalienne:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafiaitalienne' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		   OpenBanditsMenu()
        end 
    end
end)
