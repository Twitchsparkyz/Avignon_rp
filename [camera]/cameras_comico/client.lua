...
Citizen.CreateThread(function()
	...
	while true do
		...
		--local Isgendarme = PlayerData.job



		if (isNearPC() and PlayerData.job ~= nil and PlayerData.job.name == 'gendarme') then
...
function isNearPC()
	...
	local distance = GetDistanceBetweenCoords(0.0,0.0,0.0, coords.x, coords.y, coords.z, true)
