...
files {
	...
	'html/img/jobs/barnes.png',
	'html/img/jobs/motorcycle.png',
	'html/img/jobs/mercenaire.png',
	...
	'html/img/jobs/mafiaitalienne.png',
	'html/img/jobs/ragrah.png',
	'html/img/jobs/LaVague.png'
